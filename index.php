    ...
    <div class="section-first">
        ...
        <div class="container container-first">
            <div class="hero">
                ...
                <p class="hero-description"><strong>Только в октябре!</strong> Оставьте заявку на пробный урок онлайн с топовым преподавателем и получите <strong>две&nbsp;недели&nbsp;обучения&nbsp;в&nbsp;подарок!</strong></p>

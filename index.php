...
$reviews = [
    [
        ...
        'video_preview' => 'http://i3.ytimg.com/vi/WaAVxYmBCBA/mqdefault.jpg',
    ],
    [
        'header' => 'Ольга',
...
$teachers = [
    ...
    [
        ...
        'foto' => '11.png',
        'text' => '«Самое большое удовольствие от преподавания — это видеть результаты своих учеников, их живой интерес к изучению, возможность придумывать для них самые креативные и необычные задания для практики английского. Занимаясь с детьми, создала 2 онлайн игры в ВК, где они в свободное время от занятий не переставали практиковать английский язык.»',
        'features' => [
            'Имеет CAE (Certificate in advanced English)',
            '3 месяца работала в США и улучшала разговорный английский',
    ...
    [
        ...
        'foto' => '5.jpg',
        'text' => 'Со слов студентов Светлана – искренний и мягкий преподаватель, но, если дело касается достижения поставленной цели, Свете удается проявить настойчивость. Светлана успешно ведет как взрослое, так и детское направление. Светлана также является «звездой» нашего Youtube канала.',
        'features' => [
            'Сертификат TEACHING ENGLISH AS A FOREIGN LANGUAGE (TEFL)',
            'Сертификат TEACHING ENGLISH TO SPEAKERS OF OTHER LANGUAGES (TESOL)',
            'Жила около года в США, где работала преподавателем английского языка',
        ],
    ],
    ...
    [
        ...
        'features' => [
            'Санкт-Петербургский Государственный Университет, Лингвистика, Дискурс и вариативность английского языка, магистр',
            'Диплом о профессиональной переподготовке по программе «Теоретические и методические аспекты преподавания английского языка в образовательных организациях»',
        ],
    ],
    [
        'name' => 'Сабина Шейхова',
        ...
        'foto' => '6.jpg',
        'text' => '«Я очарована своей профессией! Преподавание для меня что-то естественное и помогает знакомиться с интересными людьми, общаться и обмениваться знаниями с ними. Я могу помогать человеку открывать интересный ему мир английского языка, а со своей стороны, учусь чему-то новому как преподаватель и человек. Веду работу со студентами с разным уровнем знания языка, от начального до продвинутого. Меня очень радует видеть успехи моих учеников!»',
        'features' => [
    ...
    [
        ...
        'foto' => '12.png',
        'text' => '«Еще в школе мне нравились уроки английского, для меня они обладали особой, невероятно уютной и теплой атмосферой. С тех пор я полюбила этот язык и захотела все больше погружаться в него. Я поняла, что хочу дарить такую же атмосферу другим людям, изучающим английский, дарить им ту же страсть, с которой я осваивала и продолжаю осваивать язык.»',
        'features' => [
    ...
    [
        ...
        'foto' => '9.jpg',
        'text' => '«Ещё в детстве моя любимая игра была «Школа», я всегда выступала в роли учительницы и мечтала стать ей, когда вырасту. И вот уже 6 лет я преподаю и получаю огромное удовольствие от этого! Я люблю английский и люблю людей. Преподавание помогло мне это совместить! Больше всего я радуюсь результатам студентов и их горящим глазам. Приятно чувствовать себя полезной! Я убеждена, что английский язык может выучить каждый. Все, что для этого нужно — правильный подход и желание!»',
        'features' => [
            'МИТУ-МАСИ. Преподаватель английского языка.',
            'Более года жила в США, где преподавала английский язык',
        ],
    ],
    [
        'name' => 'Анна Олейник',

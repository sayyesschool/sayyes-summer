        ...
        <div class="stydeprograms container">
            ...
            <div class="programs-content">
                ...
                <div class="programs-content__right">
                    <h3 class="programs-content__title">1. Это эффективно для прогресса в английском</h3>
                    <p class="programs-content__text">За три месяца каникул дети могут забыть почти 1/4 пройденного за год материала. Если поддерживать уровень английского в течение лета, осенью ребенок не будет тратить 1-2 месяца чтобы вернуться на прежний уровень владения языком.</p>

                    <h3 class="programs-content__title">2. Меньше стресса в начале учебного года</h3>
                    <p class="programs-content__text">В начале учебного года сложно возвращаться одновременно и к школе, и к дополнительным занятиям. Попытка включить занятия английским может вызвать еще больший стресс. Этого не случится, если ребенок продолжал занятия летом.</p>

                    <h3 class="programs-content__title">3. Час свободного времени для родителей</h3>
                    <p class="programs-content__text">Летом у детей больше свободного времени (точнее, оно все свободное:) и нет проблемы найти 25-50 минут на занятие английским. Признаться честно, для многих родителей это отличное решение вопроса “чем занять детей во время каникул”.</p>

                    <h3 class="programs-content__title">4. Возможность сделать прорыв в английском</h3>
                    <p class="programs-content__text">Для тех, кто не мог найти время плотнее заняться английским во время учебного года, летние каникулы – отличная возможность сделать настоящий рывок! Занятиям ничего не мешает, дети больше отдыхают и лучше запоминают информацию.</p>
